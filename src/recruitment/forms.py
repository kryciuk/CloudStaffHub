...
class JobOfferForm(ModelForm):
    ...
    #     if company:
    #         self.fields['city'].queryset = City.objects.filter(company=company)
    ...
    def clean_expiry_date(self):
        ...
        if expiry_date < today:
            raise forms.ValidationError(self.Meta.error_messages['expiry_date_future'],
                                        code='expiry_date_future')
        return expiry_date
...
class JobApplicationForm(ModelForm):
    ...
    def clean_consent_processing_data(self):
        ...
        if consent_processing_data is not True:
            raise forms.ValidationError(self.Meta.error_messages['consent_processing_data_required'],
                                        code='consent_processing_data_required')
