...
class RegisterCompanyView(View):
    def post(self, request):
        form_company = CompanyForm(request.POST, prefix="company")
        form = CreateUserForm(request.POST, prefix="user")
    ...
    def get(self, request):
        ...
        context = {
            "form_company": CompanyForm(prefix="company"),
            "form": CreateUserForm(prefix="user"),
